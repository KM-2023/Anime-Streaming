...
if(isset($_GET['id'])) {
    ...
    shows.description AS description, shows.duration AS duration, shows.date_aired AS date_aired, shows.producers AS producers,
    shows.status AS status, shows.actors AS actors,
...
if(isset($_POST['submit'])) {
    ...
    if (isset($_POST['inserting_comments'])) {
        if (empty($_POST['comment'])) {
            ...
            // Check if the comment already exists for the specific show and user
            $existingComment = $conn->prepare("SELECT * FROM comments WHERE show_id = :show_id AND user_id = :user_id");
            ...
            if ($existingComment->rowCount() > 0) {
                echo "<script>alert('You have already commented on this show')</script>";
            } else {
                // Insert the comment
                ...
                echo "<script>window.location.href='" . APPURL . "/anime-details.php?id=" . $show_id . "'</script>";
            }
        }


        //checking if user viewed this page
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            ...
                                            <li><span>Actors:</span> <?php echo $singleShow->actors; ?></li>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            ...
                                            <li><span>Producers:</span> <?php echo $singleShow->producers; ?></li>
