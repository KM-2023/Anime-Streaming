...
<?php
    ...
    $trendingShows = $conn->query("SELECT shows.id AS id, shows.image AS image, shows.num_available AS num_available,
     shows.num_total AS num_total, shows.title AS title, shows.genre AS genre, shows.type AS type, COUNT(views.show_id) AS count_views
    FROM shows JOIN views ON shows.id = views.show_id GROUP BY (shows.id) ORDER BY views.show_id DESC");
    ...
    <section class="hero">
        <div class="container">
            <div class="hero__slider owl-carousel">
                <?php foreach($allShows as $show) : ?> <!-- This is used to select data using the alias "show"!-->
                <div class="hero__items set-bg" data-setbg="img/<?php echo $show->image; ?>"> <!--echo here grabs the data from column name image!-->
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                <div class="label"><?php echo $show->genre; ?></div><!--here we grab the genre!-->
                                <h2><?php echo $show->title; ?></h2> <!--here we grab the titles of the shows!-->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="recent__product">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/<?php echo $allRecentlyAddedShow->image; ?>">
                    ...
                    <div class="live__product">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="img/<?php echo $allActionShow->image; ?>">
        ...
        <div class="section-title">
            ...
            <div class="product__sidebar__comment__item">
                <div class="product__sidebar__comment__item__pic">
                    <img style="width: 150px; height: 200px" src="img/<?php echo $allForYouShow->image; ?>" alt="">
                </div>
                <div class="product__sidebar__comment__item__text">
                    ...
                    <h5><a href="<?php echo APPURL; ?>/anime-details.php?id=<?php echo $allActionShow->id; ?>"><?php echo $allForYouShow->title; ?>"><?php echo $allForYouShow->title; ?></a></h5>
                    <span><i class="fa fa-eye"></i> <?php echo $allForYouShow->count_views; ?> Views</span>
                </div>
            </div>
            <?php endforeach; ?>
    </div>
